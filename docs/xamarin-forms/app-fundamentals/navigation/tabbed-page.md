...
> [!NOTE]
> **Примечание**: [ `TabbedPage` ](https://developer.xamarin.com/api/type/Xamarin.Forms.TabbedPage/) не поддерживает виртуализацию пользовательского интерфейса. Таким образом, если может снизиться производительность `TabbedPage` содержит слишком много дочерних элементов.
