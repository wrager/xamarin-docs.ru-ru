...
description: В этой статье объясняется, как добавление циклические наложения на карту, чтобы выделить круговой области карты. IOS и Android предоставляют API-интерфейсы для добавления циклические наложения к схеме, на UWP наложение отображается в виде многоугольника.
ms.prod: xamarin
