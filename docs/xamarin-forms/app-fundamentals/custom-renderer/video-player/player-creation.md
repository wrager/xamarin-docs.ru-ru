...
description: В этой статье объясняется, как реализовать пользовательское средство отрисовки видеопроигрыватель на каждой платформе, с помощью Xamarin.Forms.
ms.prod: xamarin
