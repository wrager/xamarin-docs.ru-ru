...
> [!NOTE]
> **Примечание**: `WKWebView` класса поддерживается только в iOS 8 и более поздних версий.
...
> [!NOTE]
> **Примечание**: проекты, использующие `[Export]` атрибут должен включать ссылку на `Mono.Android.Export`, или приведет к ошибке компилятора.
