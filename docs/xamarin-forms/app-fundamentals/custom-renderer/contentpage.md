...
> [!NOTE]
> **Примечание**: это необязательно для предоставления разрывами страниц в каждом проекте платформы. Если модуль подготовки страницы не зарегистрирован, будет использоваться модуль подготовки отчетов по умолчанию для страницы.
