...
description: В этой статье объясняется, как использовать жест жестом сжатия для выполнения интерактивных масштаба изображения на месте жестом сжатия.
ms.prod: xamarin
