...
description: В этой статье объясняется, как использовать класс с помощью Xamarin.Forms DependencyService для доступа к ориентации устройства из общего кода.
ms.prod: xamarin
