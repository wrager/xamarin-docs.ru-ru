...
7. В **обозревателе решений**, щелкните правой кнопкой мыши **ссылки** в проекте GTK. В **диспетчер ссылок** диалогового окна выберите **проекты** в слева, а затем установите флажок рядом с .NET Standard, PCL или общий проект:
...
7. В **Pad решения**, щелкните правой кнопкой мыши **References > Изменить ссылки...**  для GTK проекта и добавьте ссылку на проект Xamarin.Forms (.NET Standard, PCL или общий проект).
