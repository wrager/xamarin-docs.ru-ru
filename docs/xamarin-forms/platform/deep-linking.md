...
description: В этой статье показано, как использовать приложение индексирования и глубокое связывание для предоставления доступа к содержимому приложения Xamarin.Forms для поиска на устройствах iOS и Android.
ms.prod: xamarin
