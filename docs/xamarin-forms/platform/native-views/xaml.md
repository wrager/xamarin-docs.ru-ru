...
> [!NOTE]
> **Примечание**: аргументы должны совпадать с типами, необходимый для метода, конструктора или фабрики.
