...
description: Это электронную книгу предоставляет руководство по архитектуре для разработки корпоративных приложений Xamarin.Forms настраиваться, сопровождения и тестируемых.
ms.prod: xamarin
