---
title: Наследование стиля в Xamarin.Forms
description: Стили можно наследовать другие стили, чтобы сократить дублирование и включить повторное использование. В этой статье объясняется, как выполнять наследования стиля в приложении Xamarin.Forms.
ms.prod: xamarin
...
ms.locfileid: "35245098"
---
# <a name="style-inheritance-in-xamarinforms"></a>Наследование стиля в Xamarin.Forms
