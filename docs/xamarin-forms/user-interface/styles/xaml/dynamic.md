...
description: В этой статье описываются приложения Xamarin.Forms можно реакцию на изменения стиля динамически во время выполнения с помощью динамического ресурсов.
ms.prod: xamarin
