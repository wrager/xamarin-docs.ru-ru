...
[![](device-images/minimum-size.png "Стили доступны небольшое устройство на каждой платформе")](device-images/minimum-size-large.png "стили доступны небольшое устройство на каждой платформе")
