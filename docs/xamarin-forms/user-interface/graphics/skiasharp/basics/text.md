...
Вслед за этим оставшейся части метода тривиальной задачей. Он создает еще один `SKPaint` объекта границ и вызовы `DrawRoundRect` дважды. Второй вызов используется прямоугольник увеличивается за счет другой 10 точек. Первый вызов задает радиус скругления 20 пикселов; второй — скругленных углов 30 пикселей, кажется, не должен быть:
 ...
 [![](text-images/framedtext-small.png "Тройной снимок экрана со страницей в рамке текст")](text-images/framedtext-large.png "тройной снимок экрана со страницей в рамке текста")
...
[![](text-images/outlinedtext-small.png "Тройное снимок экрана: страница описанные текста")](text-images/outlinedtext-large.png "Тройное странице описано текст (снимок экрана)")
