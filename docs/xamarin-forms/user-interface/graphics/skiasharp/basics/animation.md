...
**Pulsating эллипса** страницы в [ **SkiaSharpFormsDemos** ](https://developer.xamarin.com/samples/xamarin-forms/SkiaSharpForms/SkiaSharpFormsDemos/) программы анимирует осей эллипса, чтобы он отображался в быть pulsating и даже управления Скорость этого pulsation:
