...
description: В этой статье рассматриваются преобразования при отображении графики SkiaSharp в Xamarin.Forms приложений и это демонстрируется с примерами кода.
ms.prod: xamarin
