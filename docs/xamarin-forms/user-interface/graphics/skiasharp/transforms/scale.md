...
description: Thhis статье рассматриваются преобразования масштабирования SkiaSharp масштабирование объектов для различных размеров и это демонстрируется с примерами кода.
ms.prod: xamarin
