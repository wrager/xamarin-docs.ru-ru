...
description: Данная статья более подробно рассматривается влияние и при наличии преобразования вращения SkiaSharp анимации и это демонстрируется с примерами кода.
ms.prod: xamarin
