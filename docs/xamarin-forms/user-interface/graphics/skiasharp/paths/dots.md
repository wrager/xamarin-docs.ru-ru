---
title: Точки и дефисы в SkiaSharp
description: Данная статья посвящена тому, как главный особенностей Рисование пунктирная и пунктирных линий в SkiaSharp и это демонстрируется с примерами кода.
ms.prod: xamarin
...
ms.locfileid: "35243877"
---
# <a name="dots-and-dashes-in-skiasharp"></a>Точки и дефисы в SkiaSharp
...
Ограничения максимального экрана показывает UWP, точечные и пунктирных линий для штриха из `Round`. `Round` Окончаний обводки часто обеспечивает лучший вида точек и тире толстой линии.
