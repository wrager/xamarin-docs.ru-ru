...
description: В этой статье объясняется, как использовать SkiaSharp для подготовки к просмотру кривых Безье третьего, квадратичных и conic Xamarin.Forms приложений и это демонстрируется с примерами кода.
ms.prod: xamarin
...
Внимательно посмотрите на третий снимок экрана, и вы увидите, что кривой Безье в частности отличается от полукруга угол равен 180 градусов, когда экран операций ввода-вывода показывает, что видимому помещаются корректно квартал окружность, если угол равен 90 градусов.
