...
description: В этой статье описывается настройка представлениях ListView Xamarin.Forms приложений с помощью заголовки, нижние колонтитулы, групп и переменной высоты ячейки.
ms.prod: xamarin
