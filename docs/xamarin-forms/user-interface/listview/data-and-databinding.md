...
description: В этой статье объясняется, как выполнить заполнение Xamarin.Forms ListView с данными и как использовать привязку данных с помощью ListView.
ms.prod: xamarin
