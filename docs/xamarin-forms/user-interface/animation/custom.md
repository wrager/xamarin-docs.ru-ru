---
title: Настройка анимации в Xamarin.Forms
description: В этой статье показано, как класс анимации Xamarin.FOrms используется для создания и отменить анимации, синхронизация нескольких анимаций и создание анимации, анимация свойства, которые не являются анимированы с существующие методы анимации.
ms.prod: xamarin
...
ms.locfileid: "35242980"
---
# <a name="custom-animations-in-xamarinforms"></a>Настройка анимации в Xamarin.Forms
