...
description: "Используйте AbsoluteLayout для создания пользовательских интерфейсов точно пикселей."
ms.topic: article
ms.prod: xamarin
...
[ ![](absolute-layout-images/layouts-sml.png "Макеты Xamarin.Forms")](absolute-layout-images/layouts.png "Xamarin.Forms макетов")
