...
[ ![](grid-images/layouts-sml.png "Макеты Xamarin.Forms")](grid-images/layouts.png "Xamarin.Forms макетов")
...
> [!NOTE]
> **Примечание**: значения ширины столбцов заданы как "*" по умолчанию в Xamarin.Forms, который гарантирует, что столбец будет заполнено все доступное пространство.
