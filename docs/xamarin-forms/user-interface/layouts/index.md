...
Xamarin.Forms имеет несколько макетов и возможностей для организации содержимого на экране. Каждый элемент управления макета описан ниже, а также сведения о том, как обрабатывать изменения ориентации экрана.
...
[ ![](images/layouts-sml.png "Макеты Xamarin.Forms")](images/layouts.png "Xamarin.Forms макетов")
...
### <a name="device-orientationdevice-orientationmd"></a>[Ориентации устройства](device-orientation.md)
...
### <a name="creating-a-custom-layoutcustommd"></a>[Создание пользовательских макетов](custom.md)
