...
description: В этой статье объясняется, как макет Xamarin.Forms приложений, которые прекрасно выглядят в книжной и альбомной ориентации.
ms.prod: xamarin
