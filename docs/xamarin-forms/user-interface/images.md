...
- [ **Локальные изображения** ](#Local_Images) -отображение изображений в состав приложения, включая разрешение собственного решения как iOS Сетчатка или Android версии высоким Разрешением изображения.
...
- [`FromResource`](https://developer.xamarin.com/api/member/Xamarin.Forms.ImageSource.FromResource/p/System.String/) — Требуется идентификатор ресурса в файл изображения, внедренной в приложение или PCL, **действие построения: EmbeddedResource**.
...
- **Windows Phone** -размещать изображения в корневом каталоге приложения с **действие при построении: содержимого**.
