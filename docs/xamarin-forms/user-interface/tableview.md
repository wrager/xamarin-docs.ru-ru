...
description: В этой статье объясняется, как использовать класс Xamarin.Forms TableView для представления меню прокрутки, параметров и формами ввода в приложениях.
ms.prod: xamarin
