...
description: 'Создание мобильных приложений с помощью Xamarin.Forms: Сводка раздел 1. Как Xamarin.Forms помещается в'
ms.prod: xamarin
...
- [Центр разработчиков Windows](http://dev.windows.com)
