...
- **Модель с извлечением** — данных является периодически полученный из Azure DocumentDB, базы данных SQL Azure, хранилище больших двоичных объектов Azure или SQL Server, размещенных в виртуальной машине Azure.
