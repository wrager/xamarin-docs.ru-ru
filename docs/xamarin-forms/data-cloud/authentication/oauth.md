...
description: В этой статье описывается использование Xamarin.Auth для управления процессом проверки подлинности в приложении Xamarin.Forms.
ms.prod: xamarin
