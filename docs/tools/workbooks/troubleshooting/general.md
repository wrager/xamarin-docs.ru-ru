...
description: Для книг Xamarin в этом документе описываются известные проблемы и способы их устранения. Он описывает CultureInfo, JSON проблем и многое другое.
ms.prod: xamarin
...
Начиная с версии 1.3 книг, мы удалили SkiaSharp модулей подготовки отчетов, которые мы поставляются в книгах 0.99.0, пользу SkiaSharp предоставления модулей подготовки отчетов, сам, с помощью наших [SDK](~/tools/workbooks/sdk/index.md).
