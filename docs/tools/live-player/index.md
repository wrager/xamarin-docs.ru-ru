...
2. Отладка и запустить сканирование QR-код, чтобы связать устройство.
...
## <a name="xaml-live-previewinglive-viewmd"></a>[Предварительная версия XAML Live](live-view.md)
