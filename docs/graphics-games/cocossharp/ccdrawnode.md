...
description: В этом документе описывается CCDrawNode, который предоставляет методы для рисования объектов примитивов, например линий, кругов и треугольники.
ms.prod: xamarin
