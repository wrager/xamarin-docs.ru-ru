...
## <a name="acceleration-vs-deceleration"></a>Ускорение vs. Замедление
...
### <a name="using-atan2-to-convert-offsets-to-angles"></a>С помощью Atan2 преобразовать смещения в углы
