...
Эти снимки экрана Показать конструкторов visual экрана, доступных на каждой платформе:
 ...
 [ ![](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png "Эти снимки экрана Показать конструкторов visual экрана, доступных для каждой платформы")](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png#lightbox)
