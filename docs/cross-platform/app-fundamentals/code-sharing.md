...
Самый простой способ совместного использования файлов кода является использование общий проект (появился в Xamarin Studio 5 и Visual Studio 2013 обновление 2). Общие проекты, [здесь подробно обсуждаются в](~/cross-platform/app-fundamentals/shared-projects.md).
...
- [Общий диспетчер ссылок проекта для Visual Studio 2013](http://visualstudiogallery.msdn.microsoft.com/315c13a7-2787-4f57-bdf7-adae6ed54450)
