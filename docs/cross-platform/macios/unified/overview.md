...
description: API единой Xamarin позволяет совместное использование кода Mac и операций ввода-вывода и поддержку 32- и 64-разрядных приложений, с помощью того же двоичного файла.
ms.prod: xamarin
