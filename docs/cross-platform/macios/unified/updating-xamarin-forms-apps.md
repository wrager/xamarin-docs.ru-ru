...
description: Этот документ описывает действия, которые должны выполняться для обновления приложения Xamarin.Forms классический API в единой API.
ms.prod: xamarin
