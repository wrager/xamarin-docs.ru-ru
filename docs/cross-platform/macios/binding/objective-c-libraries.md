...
|`NSString` ([дополнительные привязке `NSString` ](~/ios/internals/api-design/nsstring.md))|`string`|
|`char *`|`string` (см. также: [PlainString атрибута](~/cross-platform/macios/binding/binding-types-reference.md#plainstring))|
|`CGRect`|`CGRect`|
|`CGPoint`|`CGPoint`|
|`CGSize`|`CGSize`|
