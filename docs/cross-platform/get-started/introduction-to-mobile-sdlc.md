...
Взаимодействие с пользователем обычно реализуется на основе каркасов или макетов с помощью таких средств, как [Balsamiq](http://www.balsamiq.com/), [Mockingbird](https://gomockingbird.com/), [Visio](http://office.microsoft.com/en-us/visio/) или даже простой ручки и листа бумаги. Применение макетов позволяет проектировать взаимодействие с пользователем, не заботясь о его фактической разработке:
 ...
 [ ![](introduction-to-mobile-sdlc-images/balsamiq.png "Взаимодействие с пользователем обычно реализуется на основе каркасов или макетов с помощью таких средств, как Balsamiq")](introduction-to-mobile-sdlc-images/balsamiq.png)
...
Также решения о взаимодействии с пользователем необходимо принимать с учетом форм-фактора устройств. Так, экран планшета гораздо больше и, соответственно, может вмещать больше информации. Поэтому зачастую информация, которая выводится на телефоне на нескольких экранах, на планшете умещается на одном:
 ...
 [ ![](introduction-to-mobile-sdlc-images/iphone-vs-ipad.png "Зачастую информация, которая выводится на телефоне на нескольких экранах, на планшете умещается на одном")](introduction-to-mobile-sdlc-images/iphone-vs-ipad.png)
...
Как и в случае с механизмом взаимодействия, важно понимать, что каждая платформа использует собственный язык проектирования и даже хорошо проработанное приложение может выглядеть на них по-разному:
 ...
 [ ![](introduction-to-mobile-sdlc-images/multiplatform-1.png "Даже хорошо проработанное приложение может выглядеть по-разному на различных платформах")](introduction-to-mobile-sdlc-images/multiplatform-1.png)
