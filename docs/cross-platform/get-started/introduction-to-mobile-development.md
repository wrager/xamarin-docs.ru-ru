...
В этом руководстве содержатся подробные сведения о создании мобильного приложения Xamarin, включая следующие темы:

1.   [ **Введение в Xamarin.**](#Introduction_to_Xamarin) Перечень компонентов платформы Xamarin.
1.   [ **Принципы работы Xamarin.**](#How_Does_Xamarin_Work) Краткий обзор принципов действия Xamarin для разработки на C# на платформах iOS и Android.
1.   [ **Начало работы.**](#Sample_App) Создание приложения Xamarin для iOS, Android или всех платформ с помощью Xamarin.Forms.
