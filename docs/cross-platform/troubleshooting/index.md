...
### <a name="updating-component-references-to-nugetcomponent-nugetmd"></a>[Обновление ссылок на компоненты для NuGet](component-nuget.md)
...
### <a name="legacy-license-questionslegacy-licensesindexmd"></a>[Вопросы лицензирования прежних версий](legacy-licenses/index.md)
