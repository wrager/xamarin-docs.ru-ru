...
### <a name="can-i-use-visual-studio-2017-release-candidate-with-xamarinvisualstudio-2017-rcmd"></a>[Можно ли использовать релиз-кандидат Visual Studio 2017 с Xamarin](visualstudio-2017-rc.md)
