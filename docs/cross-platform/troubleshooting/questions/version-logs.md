...
Ссылка: [параметры командной строки](http://msdn.microsoft.com/en-us/library/aa367988.aspx)
...
Ссылка:  [ /log (devenv.exe)](http://msdn.microsoft.com/en-us/library/ms241272.aspx)
