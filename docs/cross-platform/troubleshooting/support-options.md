...
Компоненты пакета SDK для Xamarin и IDE пригодны для обращения в службу технической поддержки, как часть [преимущества для подписчиков Visual Studio](https://msdn.microsoft.com/subscriptions/bb266240) и [Microsoft Premier Support](https://www.microsoft.com/en-us/microsoftservices/support.aspx).  Это соответствует политики для других платформ разработки в Visual Studio, такие как UWP и ASP.NET.  Xamarin инцидентов отправить таким образом будут назначены в группу поддержки Xamarin.  В разделе [ответы поддержки Microsoft](https://support.microsoft.com/gp/offerprophone) Дополнительные сведения о политиках, для подобных случаев.
