...
[![Целевые значения по умолчанию версии Framework для компиляции с помощью версии Android](android-api-levels-images/vs-defaults-sml.png)](android-api-levels-images/vs-defaults.png)
...
[![Задать минимальное и Android целевой версии для требуемой версии .NET Framework](android-api-levels-images/vs-manifest-defaults-sml.png)](android-api-levels-images/vs-manifest-defaults.png)
...
[![Компиляция с помощью API уровня 25 Nougat минимум Android версии API уровнем 14](android-api-levels-images/vs-minimum-sml.png)](android-api-levels-images/vs-minimum.png)
...
[![Требуемая версия .NET framework по умолчанию используется последняя версия установлена платформой](android-api-levels-images/xs-default-target-sml.png)](android-api-levels-images/xs-default-target.png)
...
[![Настройка уровней целевого объекта и framework в параметрах проекта](android-api-levels-images/xs-default-app-sml.png)](android-api-levels-images/xs-default-app.png)
...
[ ![Минимальное и настроена на автоматический - версий используйте версию целевой платформы](android-api-levels-images/xs-minimum-sml.png)](android-api-levels-images/xs-minimum.png)
...
> [!NOTE]
> **Примечание:** начиная с августа 2018, консоли воспроизвести Google потребуется, новые приложения целевой уровень API 26 (Android 8.0) или более поздней версии.
...
[![Приложение в окне свойств проекта](android-api-levels-images/vs-target-framework-sml.png)](android-api-levels-images/vs-target-framework.png)
...
[![Построение общие раздел страницы параметров проекта](android-api-levels-images/xs-target-framework-sml.png)](android-api-levels-images/xs-target-framework.png)
...
[![Минимальное Android для целевого параметра равным компиляция с помощью пакета SDK версии](android-api-levels-images/vs-minimum-version-sml.png)](android-api-levels-images/vs-minimum-version.png)
...
[ ![Минимальная версия Android настроена на автоматический - используйте версию целевой платформы](android-api-levels-images/xs-minimum-version-sml.png)](android-api-levels-images/xs-minimum-version.png)
...
[![Целевая версия Android, равным компиляция с помощью пакета SDK версии](android-api-levels-images/vs-target-version-sml.png)](android-api-levels-images/vs-target-version.png)
...
[![Целевая версия Android настроена на автоматический - используйте версию целевой платформы](android-api-levels-images/xs-target-version-sml.png)](android-api-levels-images/xs-target-version.png)
...
[![Доступен только компиляцию с помощью параметра версии Android](android-api-levels-images/vs-library-options-sml.png)](android-api-levels-images/vs-library-options.png)
...
[ ![Страница «Общие» без минимального и целевого параметры версии сборки](android-api-levels-images/xs-library-options-sml.png)](android-api-levels-images/xs-library-options.png)
