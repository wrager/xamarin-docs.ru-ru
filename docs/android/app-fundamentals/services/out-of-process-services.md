...
[![Снимки экрана из устройство Android, показывающий, как определить разрешения, предоставляемые приложению](out-of-process-services-images/ipc-06-sml.png)](out-of-process-services-images/ipc-06.png)
