...
[ ![Схема состояния активности](images/image1-sml.png)](images/image1.png)
...
[ ![Блок-схема жизненного цикла действия](images/image2-sml.png)](images/image2.png)
...
[ ![Кнопки домашней назад и](images/image4-sml.png)](images/image4.png)
...
[ ![Блок-схема состояния пакета](images/image3-sml.png)](images/image3.png)
...
[ ![Не отображаются предыдущее значение](images/07-sml.png)](images/07.png)
...
> [!NOTE]
> **Примечание:** это важно всегда вызов базовую реализацию `OnSaveInstanceState` , чтобы состояние иерархии представление также будет сохранен.
...
[ ![Данные сохраняются в альбомной ориентации](images/08-sml.png)](images/08.png)
...
[ ![Результаты, отображаемые на экране](images/06-sml.png)](images/06.png)
