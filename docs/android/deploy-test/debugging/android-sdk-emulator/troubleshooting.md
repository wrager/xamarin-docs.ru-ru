...
[![Отключение предупреждений о проблемах с ускорением виртуальных устройств Android](troubleshooting-images/win/06-disable-perf-warnings-sml.png)](troubleshooting-images/win/06-disable-perf-warnings.png)
