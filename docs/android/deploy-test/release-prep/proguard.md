...
[ ![Действия сжатия и оптимизации](proguard-images/01-xa-chain-sml.png)](proguard-images/01-xa-chain.png)
...
1.  Убедитесь, что для проекта задана конфигурация **Выпуск** (это важно, так как перед запуском ProGuard должен быть запущен компоновщик): 
    ...
    [ ![Выбор конфигурации "Выпуск"](proguard-images/02-set-release-sml.png)](proguard-images/02-set-release.png)
...
2.  Включите ProGuard, установив флажок **Включить ProGuard** на вкладке **Упаковка**, которая откроется после выбора пунктов **Свойства > Параметры Android**: 
    ...
    [![Выбранный параметр "Включить Proguard"](proguard-images/03-enable-proguard-sml.png)](proguard-images/03-enable-proguard.png)
...
[![Выбранное действие сборки ProguardConfiguration](proguard-images/04-build-action-sml.png)](proguard-images/04-build-action.png)
