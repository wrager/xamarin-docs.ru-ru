...
Дополнительные сведения о настройке эмулятор Android для тестирования и отладки см. в разделе [отладки с использованием эмулятора Google Android](~/android/deploy-test/debugging/android-sdk-emulator/index.md).
