...
[![Снимок экрана примера автоматически заполнять имена, содержащие «Калифорния» со списком](auto-complete-images/helloautocomplete.png)](auto-complete-images/helloautocomplete.png)
