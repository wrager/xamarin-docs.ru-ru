---
title: С помощью SQLite.NET с Android
description: Библиотеки SQLite.NET PCL NuGet механизм данных простого доступа для Xamarin.Android приложений.
ms.prod: xamarin
...
> [!TIP]
> Существует несколько различных пакетов SQLite — не забудьте сделать правильный выбор (top результат поиска может быть).
