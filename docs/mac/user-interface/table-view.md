...
[ ![](table-view-images/intro01.png "Пример таблицы")](table-view-images/intro01.png)
...
[ ![](table-view-images/edit01.png "При выборе основных раскадровки")](table-view-images/edit01.png)

Откроется окно конструктора в построителе Xcode элемента интерфейса:

[ ![](table-view-images/edit02.png "Изменение пользовательского интерфейса в Xcode")](table-view-images/edit02.png)

Тип `table` в **библиотеки инспектора** поле поиска для облегчения поиска элементов управления, представление таблицы:

[ ![](table-view-images/edit03.png "При выборе таблицы представления из библиотеки")](table-view-images/edit03.png)
...
[ ![](table-view-images/edit04.png "Изменение ограничений")](table-view-images/edit04.png)

Выберите режим таблицы **иерархии интерфейса** и следующие свойства доступны в **инспектора атрибут**:

[ ![](table-view-images/edit05.png "Инспектор атрибута")](table-view-images/edit05.png)
...
[ ![](table-view-images/edit06.png "Инспектор атрибута")](table-view-images/edit06.png)
...
[ ![](table-view-images/edit07.png "Инспектор атрибута")](table-view-images/edit07.png)
...
[ ![](table-view-images/edit08.png "Инспектор атрибута")](table-view-images/edit08.png)
...
[ ![](table-view-images/edit09.png "Инспектор атрибута")](table-view-images/edit09.png)
...
[ ![](table-view-images/edit10.png "Выбор представления ячейки таблицы")](table-view-images/edit10.png)
...
1. Переключитесь в **помощника редактор** и убедитесь, что `ViewController.h` выбран файл: 
    ...
    [ ![](table-view-images/edit11.png "Редактор помощника")](table-view-images/edit11.png)
...
3. Создание **розетки** таблицы представления, вызываемых `ProductTable`: 
    ...
    [ ![](table-view-images/edit13.png "Настройка выхода")](table-view-images/edit13.png)
4. Создание **торговцам** таблицы столбцы, а также называется `ProductColumn` и `DetailsColumn`: 

    [ ![](table-view-images/edit14.png "Настройка выхода")](table-view-images/edit14.png)
...
[ ![](table-view-images/populate01.png "Создание пустой класс")](table-view-images/populate01.png)
...
[ ![](table-view-images/populate02.png "Запустите образец приложения")](table-view-images/populate02.png)
...
[ ![](table-view-images/sort01.png "Задание ключа сортировки")](table-view-images/sort01.png)

Выберите `Details` столбца, введите `Description` для **ключа сортировки**, `compare:` для **селектор** и выберите `Ascending` для **порядок**:

[ ![](table-view-images/sort02.png "Задание ключа сортировки")](table-view-images/sort02.png)
...
[ ![](table-view-images/sort03.png "Запустите пример приложения")](table-view-images/sort03.png)
...
[ ![](table-view-images/select01.png "Инспектор атрибута")](table-view-images/select01.png)
...
[ ![](table-view-images/select02.png "Инспектор атрибута")](table-view-images/select02.png)
...
[ ![](table-view-images/type01.png "Тип выбора параметра")](table-view-images/type01.png)
...
[ ![](table-view-images/type02.png "Запустите образец приложения")](table-view-images/type02.png)
...
[ ![](table-view-images/reorder01.png "Инспектор атрибута")](table-view-images/reorder01.png)
...
[ ![](table-view-images/reorder02.png "Пример упорядоченный столбцов")](table-view-images/reorder02.png)
...
[ ![](table-view-images/editing01.png "Пример изменения ячейки")](table-view-images/editing01.png)
...
[ ![](table-view-images/delete01.png "Изменение имени столбца")](table-view-images/delete01.png)
...
[ ![](table-view-images/delete02.png "В таблице, представлении с кнопками, удаление")](table-view-images/delete02.png)

Когда пользователь щелкает **удалить** кнопки, предупреждение будет отображаться запросом на удаление данной строки:

[ ![](table-view-images/delete03.png "Создает предупреждение удаления строк")](table-view-images/delete03.png)

Если пользователь решит delete, строка будет удалена и перерисовывается таблицы:

[ ![](table-view-images/delete04.png "После удаления строки таблицы")](table-view-images/delete04.png)
