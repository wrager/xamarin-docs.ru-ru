...
---
# <a name="outline-views"></a>Представления структуры
...
[ ![](outline-view-images/populate03.png "Запустите пример приложения")](outline-view-images/populate03.png)
...
[ ![](outline-view-images/edit01.png "При выборе основных раскадровки")](outline-view-images/edit01.png)

Откроется окно конструктора в построителе Xcode элемента интерфейса:

[ ![](outline-view-images/edit02.png "Изменение пользовательского интерфейса в Xcode")](outline-view-images/edit02.png)

Тип `outline` в **библиотеки инспектора** поле поиска для облегчения поиска представление структуры элементов управления:

[ ![](outline-view-images/edit03.png "При выборе структура из библиотеки")](outline-view-images/edit03.png)
...
[ ![](outline-view-images/edit04.png "Изменение ограничений")](outline-view-images/edit04.png)

Выберите режим структуры **иерархии интерфейса** и следующие свойства доступны в **инспектора атрибут**:

[ ![](outline-view-images/edit05.png "Инспектор атрибута")](outline-view-images/edit05.png)
...
[ ![](outline-view-images/edit06.png "Инспектор атрибута")](outline-view-images/edit06.png)
...
[ ![](outline-view-images/edit07.png "Инспектор атрибута")](outline-view-images/edit07.png)
...
[ ![](outline-view-images/edit08.png "Инспектор атрибута")](outline-view-images/edit08.png)
...
[ ![](outline-view-images/edit09.png "Инспектор атрибута")](outline-view-images/edit09.png)
...
[ ![](outline-view-images/edit11.png "Выбор представления ячейки таблицы")](outline-view-images/edit10.png)
...
1. Переключитесь в **помощника редактор** и убедитесь, что `ViewController.h` выбран файл: 
    ...
    [ ![](outline-view-images/edit11.png "Выбор правильного h-файл")](outline-view-images/edit11.png)
...
3. Создание **розетки** представление структуры, вызываемых `ProductOutline`: 
    ...
    [ ![](outline-view-images/edit13.png "Настройка выхода")](outline-view-images/edit13.png)
4. Создание **торговцам** таблицы столбцы, а также называется `ProductColumn` и `DetailsColumn`: 

    [ ![](outline-view-images/edit14.png "Настройка выхода")](outline-view-images/edit14.png)
...
[ ![](outline-view-images/populate01.png "Создание пустой класс")](outline-view-images/populate01.png)
...
[ ![](outline-view-images/populate02.png "Свернутое представление")](outline-view-images/populate02.png)

Если мы развернуть узел в представлении структуры, он будет выглядеть следующим образом:

[ ![](outline-view-images/populate03.png "Расширенное представление")](outline-view-images/populate03.png)
...
[ ![](outline-view-images/sort01.png "Установка ключа порядка сортировки")](outline-view-images/sort01.png)
...
[ ![](outline-view-images/sort02.png "Пример отсортированных выходных данных")](outline-view-images/sort02.png)
...
[ ![](outline-view-images/select01.png "Инспектор атрибута")](outline-view-images/select01.png)
...
[ ![](outline-view-images/select02.png "Инспектор атрибута")](outline-view-images/select02.png)
...
[ ![](outline-view-images/type01.png "Изменение типа строки")](outline-view-images/type01.png)
...
[ ![](outline-view-images/reorder01.png "Инспектор атрибута")](outline-view-images/reorder01.png)
...
[ ![](outline-view-images/reorder02.png "Пример изменения порядка столбцов")](outline-view-images/reorder02.png)
...
[ ![](outline-view-images/editing01.png "Пример изменения ячейки")](outline-view-images/editing01.png)
