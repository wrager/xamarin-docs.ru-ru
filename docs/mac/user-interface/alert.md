...
[![](alert-images/alert03.png "Оповещения отображаются в виде листа")](alert-images/alert03.png#lightbox)
...
[![](alert-images/alert04.png "Предупреждение с трех кнопок")](alert-images/alert04.png#lightbox)
...
[![](alert-images/alert05.png "Три кнопки предупреждения, отображаемого в качестве листа")](alert-images/alert05.png#lightbox)
...
[![](alert-images/alert06.png "Предупреждение с Отключение кнопки")](alert-images/alert06.png#lightbox)
...
[![](alert-images/alert08.png "Если выполняется код ниже отображается")](alert-images/alert08.png#lightbox)
