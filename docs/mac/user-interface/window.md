...
В зависимости от его назначения приложения Xamarin.Mac может представлять одно или несколько окон на экране для управления и координации он отображает данные и работает с. Основной функции окна являются:
