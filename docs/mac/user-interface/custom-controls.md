...
[![](custom-controls-images/custom02.png "Редактирование раскадровки в Xcode")](custom-controls-images/custom02.png#lightbox)

Затем перетащите `Custom View` в пользовательском интерфейсе конструктора:

[![](custom-controls-images/custom03.png "При выборе представления из библиотеки")](custom-controls-images/custom03.png#lightbox)
...
[![](custom-controls-images/custom04.png "Представление класс параметров")](custom-controls-images/custom04.png#lightbox)
