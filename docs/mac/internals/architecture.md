...
[![Схема, показывающая общий обзор архитектуры](architecture-images/mac-arch.png "схема, показывающая общий обзор архитектуры")](architecture-images/mac-arch-large.png)
