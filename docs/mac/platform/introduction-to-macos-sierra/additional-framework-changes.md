...
description: В этом документе описываются незначительные изменения и усовершенствования в существующие платформы, представленные в macOS Сьерра. Он проверяет изменения framework ускорением, AppKit, AVFoundation, основных данных, образ Core, Foundation и многое другое.
ms.prod: xamarin
