...
[![Пример выполняемого приложения](databases-images/intro01.png "пример выполняемого приложения")](databases-images/intro01-large.png)
...
2. Выберите оба **Mono.Data.Sqlite** и **System.Data** сборки: 
    ...
    [![Добавление необходимых ссылок](databases-images/reference01.png "добавление необходимых ссылок")](databases-images/reference01-large.png)
...
[![Предоставление доступа к розетке поле со списком](databases-images/combo01.png "предоставление доступа к розетке поле со списком")](databases-images/combo01-large.png)
...
2. Введите `SQLite.net` в **поле поиска** и выберите **sqlite net** входа:
    ...
    [![При добавлении пакета SQLite NuGet](databases-images/nuget01.png "при добавлении пакета SQLite NuGet")](databases-images/nuget01-large.png)
...
[![Предоставление доступа к розетке представление таблицы](databases-images/table01.png "предоставление доступа к розетке представление таблицы")](databases-images/table01-large.png)
