---
title: 'Xamarin.Essentials: фонарика'
description: Этот документ описывает класс фонарика в Xamarin.Essentials, имеющий возможность включить или отключить камеру устройства флэш-памяти, чтобы он стал фонарик.
...
ms.locfileid: "34782428"
---
# <a name="xamarinessentials-flashlight"></a>Xamarin.Essentials: фонарика
...
- [Фонарика исходного кода](https://github.com/xamarin/Essentials/tree/master/Xamarin.Essentials/Flashlight)
