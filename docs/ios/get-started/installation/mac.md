---
title: "Установка"
description: "В этом учебнике демонстрируются пути установки для Xamarin.iOS."
ms.topic: article
ms.prod: xamarin
...
---
# <a name="installing-and-configuring-xamarinios-on-mac"></a>Установка и настройка Xamarin.iOS на устройство Mac

> [!NOTE]
> Это содержимое перемещено в руководства по установке Visual Studio для Mac на веб-сайте [docs.microsoft.com](https://docs.microsoft.com/en-us/visualstudio/mac/installation).
