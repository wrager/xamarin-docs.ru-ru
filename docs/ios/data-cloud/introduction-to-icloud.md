---
title: С помощью iCloud с Xamarin.iOS
description: Этот документ описывает iCloud и использовать его в приложениях Xamarin.iOS. Он описывает, значение ключа хранилища, хранения документов и резервного копирования iCloud.
ms.prod: xamarin
...
ms.locfileid: "34785548"
---
# <a name="using-icloud-with-xamarinios"></a>С помощью iCloud с Xamarin.iOS
