...
[ ![](system.data-images/edit-references-sml.png "Добавление новой ссылки")](system.data-images/edit-references.png)
...
> [!IMPORTANT]
> **Предупреждение:** как упоминалось в приведенном выше примере, считается плохой практикой для внедрения строки в командах SQL, поскольку делает код уязвимым для [атаки SQL injection](http://en.wikipedia.org/wiki/SQL_injection).
