...
description: В этом документе описывается работа с CloudKit в Xamarin.iOS. Он предоставляет общие сведения о CloudKit и описывает, как включить его, CloudKit удобства API, масштабируемость, учетные записи пользователей и разработки и рабочих средах.
ms.prod: xamarin
