...
description: В этом документе описывается работа с элементами tvOS страницы в приложении, созданном с помощью Xamarin. Содержит подробное описание элементов управления на странице, описывается, как настроить их в раскадровках и рассматриваются как реагировать на события изменения страницы.
ms.prod: xamarin
