...
> [!IMPORTANT]
> **Примечание:** панелей навигации полностью прозрачны по умолчанию. Следует соблюдать осторожность, чтобы содержимое панели навигации оставались для чтения над содержимым под ним. Например, при в табличном представлении или коллекции прокрутка содержимого под ним.
