...
description: В этом документе описывается работа с панели навигации в приложении tvOS, созданных с помощью Xamarin. В нем описывается настройка панели навигации в раскадровку и реагирование на события из этих кнопок.
ms.prod: xamarin
