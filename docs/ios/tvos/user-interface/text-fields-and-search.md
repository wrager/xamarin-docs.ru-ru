...
[![](text-fields-and-search-images/intro01.png "Пример поиска")](text-fields-and-search-images/intro01.png#lightbox)
...
[![](text-fields-and-search-images/text01.png "Текстового поля в tvOS")](text-fields-and-search-images/text01.png#lightbox)
...
[![](text-fields-and-search-images/keyboard01.png "Удаленное Siri клавиатуры")](text-fields-and-search-images/keyboard01.png#lightbox)
...
1. Выберите **текстовые поля** и дать каждому уникальный **имя** в **мини-приложение** вкладке **Pad свойства**: 
    ...
    [![](text-fields-and-search-images/text03.png "На вкладке панели свойств мини-приложения")](text-fields-and-search-images/text03.png#lightbox)
...
1. Прокрутите вниз, чтобы определить свойства, такие как **проверки правописания**, **капитализации** и значение по умолчанию **тип клавиатуры**: 
    ...
    [![](text-fields-and-search-images/text05.png "Проверка орфографии, регистр символов и значение по умолчанию тип клавиатуры")](text-fields-and-search-images/text05.png#lightbox) 
...
1. Прокрутите вниз, чтобы определить свойства, такие как **проверки правописания**, **капитализации** и значение по умолчанию **тип клавиатуры**: 
    ...
    [![](text-fields-and-search-images/text05-vs.png "Проверка орфографии, регистр символов и значение по умолчанию тип клавиатуры")](text-fields-and-search-images/text05-vs.png#lightbox) 
1. Сохраните изменения раскадровки.
...
1. Перетащите новый контроллер представление коллекции раскадровки для представления результатов поиска пользователя: 
    ...
    [![](text-fields-and-search-images/search02.png "Контроллер представление коллекции")](text-fields-and-search-images/search02.png#lightbox)
...
1. Макет конструктора из **прототип ячейки** и предоставления каждого элемента с уникальным **имя** в **мини-приложение** вкладке **свойства обозревателя**: 
    ...
    [![](text-fields-and-search-images/search05.png "Макет конструктора прототипа ячейки")](text-fields-and-search-images/search05.png#lightbox)
1. Сохраните изменения раскадровки.
...
1. Перетащите новый контроллер представление коллекции раскадровки для представления результатов поиска пользователя: 
    ...
    [![](text-fields-and-search-images/seach02-vs.png "Контроллер представление коллекции")](text-fields-and-search-images/seach02-vs.png#lightbox)
...
1. Макет конструктора из **прототип ячейки** и предоставления каждого элемента с уникальным **имя** в **мини-приложение** вкладке **свойства обозревателя**: 
    ...
    [![](text-fields-and-search-images/search05-vs.png "Макет конструктора прототипа ячейки")](text-fields-and-search-images/search05-vs.png#lightbox)
1. Сохраните изменения раскадровки.
