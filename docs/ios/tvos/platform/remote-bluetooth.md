---
title: Siri Remote и контроллеры Bluetooth для tvOS в Xamarin
description: В этой статье описана работа с удаленного Siri и игровые устройства Bluetooth в tvOS приложений, написанных с помощью Xamarin.
ms.prod: xamarin
...
ms.locfileid: "34789194"
---
# <a name="siri-remote-and-bluetooth-controllers-for-tvos-in-xamarin"></a>Siri Remote и контроллеры Bluetooth для tvOS в Xamarin
...
|---|---|---|
|**Поверхность сенсорного ввода**<br />Перейдите к экрану перейдите, нажмите клавишу, чтобы выбрать и удерживайте контекстных меню.|**TAP/считывание**<br />Навигация по пользовательскому Интерфейсу между элементами может иметь фокус.<br /><br />**Нажмите кнопку**<br />Активация выбранного элемента (фокус).|**TAP/считывание**<br />Зависит от структуры игры и может использоваться как D-панель, коснувшись краев.<br /><br />**Нажмите кнопку**<br />Выполните основную кнопку функцию.|
...
|**Siri, поиска**<br />В странах с Siri нажмите и удерживайте для управления речи, в любой другой стране, отображает экран поиска.|Н/Д|Н/Д|
|**Воспроизведение/пауза**<br />Воспроизведения и приостановки мультимедиа или предоставляет дополнительной функции в приложениях.|Начинает воспроизведение мультимедиа и приостановки или возобновления воспроизведения.|Выполняет функцию вторую кнопку или пропускает начальный видео (если существует).|
