...
> [!IMPORTANT]
> Siri считает указания пользовательского словаря и включают в себя все термины, как можно. Однако пространства для пользовательского словаря ограничено, сделав его необходимо зарегистрировать _только_ терминологии, могут вызвать путаницу, поэтому сводя к минимуму общее число зарегистрированных слов.
