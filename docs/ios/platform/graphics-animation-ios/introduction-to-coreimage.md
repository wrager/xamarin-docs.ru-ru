...
description: Образ Core — это новая платформа, появившиеся с iOS 5, чтобы обеспечить обработку изображений и видео расширения функциональности в реальном времени. В этой статье описаны эти возможности с образцами Xamarin.iOS.
ms.prod: xamarin
...
ms.locfileid: "34786636"
---
# <a name="core-image-in-xamarinios"></a>Образ Core в Xamarin.iOS

_Образ Core — это новая платформа, появившиеся с iOS 5, чтобы обеспечить обработку изображений и видео расширения функциональности в реальном времени. В этой статье описаны эти возможности с образцами Xamarin.iOS._

Образ Core — это новая платформа, представленные в iOS 5, который предоставляет ряд встроенных фильтров и применяются изображения и видеоролики, включая обнаружение лицевой стороны.
...
Эти примеры поможет приступить к работе, включение функции образ Core в приложения Xamarin.iOS.
...
В этой статье показано, как использовать некоторые новые возможности образ Core framework iOS 5 как обнаружение лицевой и применения фильтров к изображению. Десятки другое изображение фильтры доступны в платформу для использования.
...
- [С помощью фильтров образа ядра](https://developer.apple.com/library/prerelease/ios/#documentation/GraphicsImaging/Conceptual/CoreImaging/ci_tasks/ci_tasks.html)
