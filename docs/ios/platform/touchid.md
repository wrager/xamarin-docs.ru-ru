...
[![](touchid-images/image1.png "На этой диаграмме показано, как приложение взаимодействует с цепочки ключей")](touchid-images/image1.png#lightbox)
...
> [!NOTE]
> После извлечения из цепочки ключей, с помощью секрета, все ссылки на данные должны автоматически удаляться из памяти. Никогда не назначайте ее в глобальной переменной.
...
[![](touchid-images/image2.png "Эта схема показывает, каким образом этот новый атрибут привязывается остальной части цепочки ключей")](touchid-images/image2.png#lightbox)
...
|--- |--- |--- |
|Устройства без ввода секретного кода|Нет доступа|Нет|
|Устройства с секретного кода|Требуется секретного кода|Нет|
|Устройство с кодом сенсорного ввода|Предпочитаемое Touch ID|Позволяет секретного кода|
...
[![](touchid-images/image13a.png "С помощью локальной проверки подлинности без цепочки ключей служб")](touchid-images/image13a.png#lightbox)
...
[![](touchid-images/image8.png "Выделенные строки показано использование локальной проверки подлинности")](touchid-images/image8.png#lightbox)
...
[![](touchid-images/image10.png "Используйте InvokeOnMainThread для локальной проверки подлинности")](touchid-images/image10.png#lightbox)
...
[![](touchid-images/image11.png "Вызовите метод PerformSegue переход MasterViewController")](touchid-images/image11.png#lightbox)
