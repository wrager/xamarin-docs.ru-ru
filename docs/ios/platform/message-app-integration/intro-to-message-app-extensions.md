...
> [!IMPORTANT]
> **Примечание:** наклейке изображения всегда должны предоставляться в `@3x` разрешение в диапазоне от 300 x 300 для 618 x 618 пикселей. Система автоматически создаст `@2x` и `@1x` версий во время выполнения при необходимости.
