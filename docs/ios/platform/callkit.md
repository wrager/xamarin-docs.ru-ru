...
[ ![](callkit-images/callkit01.png "Служба CallKit стека")](callkit-images/callkit01.png)
...
[ ![](callkit-images/callkit02.png "Архитектура приложения MonkeyCall")](callkit-images/callkit02.png)
...
[ ![](callkit-images/callkit03.png "Взаимодействие с помощью CXProvider системы")](callkit-images/callkit03.png)
...
[ ![](callkit-images/callkit04.png "Отчеты в систему с помощью CXCallController")](callkit-images/callkit04.png)
...
[ ![](callkit-images/callkit05.png "Удаленный пользователь начинает диалог VOIP")](callkit-images/callkit05.png)
...
[ ![](callkit-images/callkit06.png "Пользователь отвечает на входящий звонок VOIP")](callkit-images/callkit06.png)
...
[ ![](callkit-images/callkit07.png "Пользователь завершает вызов из в рамках пользовательского интерфейса приложения")](callkit-images/callkit07.png)
...
[ ![](callkit-images/callkit08.png "Получает цель вызова начала")](callkit-images/callkit08.png)
...
[ ![](callkit-images/callkit09.png "Начальная последовательность вызова действия")](callkit-images/callkit09.png)
...
3. Выберите **iOS** > **расширения** > **вызывать расширения каталогов** и нажмите кнопку **Далее** кнопки: 
    ...
    [ ![](callkit-images/calldir01.png "Создание нового расширения вызовите каталога")](callkit-images/calldir01.png)
4. Введите **имя** расширение и нажмите кнопку **Далее** кнопки: 

    [ ![](callkit-images/calldir02.png "Введите имя для модуля")](callkit-images/calldir02.png)
5. Настройка **имя проекта** и/или **имя решения** , если требуется и нажмите кнопку **создать** кнопки: 

    [ ![](callkit-images/calldir03.png "Создание проекта")](callkit-images/calldir03.png) 
...
3. Выберите **iOS** > **расширения** > **вызывать расширения каталогов** и нажмите кнопку **Далее** кнопки: 
    ...
    [ ![](callkit-images/calldir01w.png "Создание нового расширения вызовите каталога")](callkit-images/calldir01.png)
