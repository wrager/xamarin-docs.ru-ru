...
> [!IMPORTANT]
> **Примечание:** эти сведения на этой странице предназначены для клиентов с уже в магазине приложений, предназначенных для iOS 8 или более ранней версии, приложения, которые уже не отправили обновлений на совместимость iOS 9. Если вы уже используете последние версии - Xcode 7 и 9 Xamarin.iOS — для разработки приложений, посетите [Знакомство с iOS 9](~/ios/platform/introduction-to-ios9/index.md).
