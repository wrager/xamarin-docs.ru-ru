---
title: Расширения в Xamarin.iOS iOS
description: Этот документ описывает расширений, представляющих собой мини-приложения, представленных операций ввода-вывода в стандартных контекста, например в центр уведомлений. Он описывает способ создать расширение и взаимодействовать с ним из родительского приложения.
ms.prod: xamarin
...
ms.locfileid: "34786734"
---
# <a name="ios-extensions-in-xamarinios"></a>Расширения в Xamarin.iOS iOS
