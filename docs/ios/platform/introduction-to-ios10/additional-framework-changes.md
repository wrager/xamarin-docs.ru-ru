...
description: В этом документе описываются незначительные изменения и усовершенствования, внесенные в существующие платформы в iOS 10 и описывает, как сделать использование этих обновлений в Xamarin.iOS.
ms.prod: xamarin
