---
title: "Общие сведения о упреждающего предложения"
...
> [!IMPORTANT]
> **Примечание:** [MKMapItem](https://developer.xamarin.com/api/type/MapKit.MKMapItem/) объект, получающий приложения не содержит сведений, широты и долготы и потребует геокодирования.
