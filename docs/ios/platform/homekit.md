...
[ ![](homekit-images/accessory01.png "Приложения с поддержкой пример HomeKit")](homekit-images/accessory01.png)
...
4. Убедитесь, что **HomeKit** службы проверки для данного ИД: 
    ...
    [ ![](homekit-images/provision01.png "Включить службу HomeKit для данного ИД")](homekit-images/provision01.png)
5. Сохраните изменения.
4. Щелкните **профили подготовки** > **разработки** и создание нового профиля подготовки для приложения: 

    [ ![](homekit-images/provision02.png "Создание нового профиля подготовки для приложения")](homekit-images/provision02.png)
...
6. Измените параметры проекта Xamarin.iOS и убедитесь, что вы используете подготовительный профиль, который вы только что создали: 
    ...
    [ ![](homekit-images/provision03.png "Выберите только что созданный профиль подготовки")](homekit-images/provision03.png)
7. Далее следует изменить на **Info.plist** файл и убедитесь, что вы используете идентификатор приложения, который использовался для создания профиля подготовки: 
    ...
    [ ![](homekit-images/provision04.png "Задать идентификатор приложения ")](homekit-images/provision04.png)
8. Наконец, измените вашей **Entitlements.plist** файл и убедитесь, что **HomeKit** выбрал права: 

    [ ![](homekit-images/provision05.png "Включить правах HomeKit")](homekit-images/provision05.png)
...
> [!IMPORTANT]
> **Примечание:** тестирование приложение включен HomeKit требует реальных операций ввода-вывода устройства, правильно подготовлен для разработки приложений. Не удается проверить HomeKit из эмулятора iOS.
...
2. Загрузить **дополнительные средства для Xcode xxx** (где xxx — Xcode, установленной версии): 
    ...
    [ ![](homekit-images/simulator01.png "Загрузить дополнительные средства для Xcode")](homekit-images/simulator01.png)
...
1. В папке приложения запустите симулятор стандартную программу HomeKit: 
    ...
    [ ![](homekit-images/simulator02.png "Имитатор аксессуаров HomeKit")](homekit-images/simulator02.png)
2. Нажмите кнопку  **+**  и выберите пункт **нового вспомогательного компонента...** : 

    [ ![](homekit-images/simulator03.png "Добавление нового вспомогательного компонента")](homekit-images/simulator03.png)
3. Введите сведения о новых стандартную программу и нажмите кнопку **Готово** кнопки: 

    [ ![](homekit-images/simulator04.png "Введите сведения о новый метод")](homekit-images/simulator04.png)
4. Нажмите кнопку **добавить службу...** и выберите из раскрывающегося списка тип службы: 

    [ ![](homekit-images/simulator05.png "Выберите из раскрывающегося списка тип службы")](homekit-images/simulator05.png)
5. Укажите **имя** службы и нажмите кнопку **Готово** кнопки: 

    [ ![](homekit-images/simulator06.png "Введите имя для службы")](homekit-images/simulator06.png)
6. Можно предоставить необязательный характеристики службы, щелкнув **добавьте характеристика** кнопки и настроить необходимые параметры: 
    ...
    [ ![](homekit-images/simulator07.png "Настройка обязательных параметров")](homekit-images/simulator07.png)
...
[ ![](homekit-images/info01.png "Диалоговое окно разрешений HomeKit")](homekit-images/info01.png)
...
4. В раскрывающемся списке выберите **конфиденциальность - Описание использования HomeKit**: 
    ...
    [ ![](homekit-images/info02.png "Выберите конфиденциальность - Описание использования HomeKit")](homekit-images/info02.png)
5. Введите описание для почему приложение хочет получить доступ к базе данных HomeKit пользователя: 

    [ ![](homekit-images/info03.png "Введите описание")](homekit-images/info03.png)
6. Сохраните изменения в файле.

> [!IMPORTANT]
> **Примечание:** не удалось задать `NSHomeKitUsageDescription` ключа в `Info.plist` файла приведет к приложению _без вмешательства пользователя со сбоем_ (закрывается в системе во время выполнения) без ошибок, при выполнении в iOS 10 (или более поздней).
...
[ ![](homekit-images/home01.png "Пользователь будет запрашиваться, следует ли разрешить ему доступ к информации о HomeKit")](homekit-images/home01.png)
...
> [!IMPORTANT]
> **Примечание:** `AlertView.PresentOKAlert` метод, используемый в приведенном выше примере — это вспомогательный класс в приложении HomeKitIntro, которое позволяет работать с iOS оповещения проще.
...
> [!IMPORTANT]
> **Примечание:** `StartSearchingForNewAccessories` нельзя оставлять запущен на длительное время, поскольку отрицательно влияет на время автономной работы и производительность устройства iOS. Apple предлагает вызова `StopSearchingForNewAccessories` после минуты или только поиска при появлении пользовательского интерфейса аксессуаров найти для пользователя.
...
[ ![](homekit-images/accessory01.png "Поиск нового вспомогательного компонента")](homekit-images/accessory01.png)
...
[ ![](homekit-images/accessory02.png "Введите код настройки для устройства, добавление")](homekit-images/accessory02.png)

В симуляторе аксессуаров HomeKit это число можно найти в **код установки** поля:

[ ![](homekit-images/accessory03.png "Код настройки поля в симуляторе аксессуаров HomeKit")](homekit-images/accessory03.png)
...
[ ![](homekit-images/accessory04.png "Пример стандартную программу")](homekit-images/accessory04.png)
...
[ ![](homekit-images/accessory05.png "Отображение сведений о службе")](homekit-images/accessory05.png)
...
[ ![](homekit-images/test01.png "Изменение состояния света в приложения iOS")](homekit-images/test01.png)
