...
description: Этот документ описывает EventKit и способ его использования в Xamarin.iOS. В нем описывается календарей, событий календаря и напоминания, выполняет поиск в классы, обычно используемые при программировании с EventKit и многое другое.
ms.prod: xamarin
