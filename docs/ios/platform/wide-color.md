---
title: "Широкую цветовую"
description: "В этой статье рассматриваются широкую цветовую и как он может использоваться в приложении Xamarin.iOS или Xamarin.Mac."
ms.topic: article
ms.prod: xamarin
...
[ ![](wide-color-images/color00.png "Цветовое пространство")](wide-color-images/color00.png)
...
[ ![](wide-color-images/color02.png "Компоненты цвета может также называться цветовых каналов")](wide-color-images/color02.png)
...
[ ![](wide-color-images/color01.png "Системы координат, который используется для сравнения и вычисления цветов предоставляют основные цвета")](wide-color-images/color01.png)
...
[ ![](wide-color-images/color03.png "Пример палитру цветов")](wide-color-images/color03.png)
...
[ ![](wide-color-images/color04.png "Новое пространство цвет для отображения P3")](wide-color-images/color04.png)
...
[ ![](wide-color-images/color05.png "Принципы работы значения вне нуля до единицы в расширенный диапазон sRGB цветовое пространство")](wide-color-images/color05.png)
...
> [!IMPORTANT]
> **Примечание:** использование **сохранить для веб-** или **Экспорт активы** функции найти в наиболее популярных изменения программного обеспечения изображения _не будет_ работы для образов широкую цветовую с момента Эти функции для поддержки спецификации формата необходимый файл еще не были обновлены.
