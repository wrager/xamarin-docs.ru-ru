...
description: В этом документе описывается создание C# для привязки к код Objective-C, благодаря чему использовать собственные библиотеки и CocoaPods приложения Xamarin.iOS.
ms.prod: xamarin
