...
##  <a name="introduction-to-ios-10iosplatformintroduction-to-ios10indexmd"></a>[Общие сведения о 10 iOS](~/ios/platform/introduction-to-ios10/index.md)
...
##  <a name="document-pickeriosplatformdocument-pickermd"></a>[Выбор документа](~/ios/platform/document-picker.md)
...
##  <a name="handoffiosplatformhandoffmd"></a>[Перемещение вручную](~/ios/platform/handoff.md)
...
##  <a name="ios-gaming-apisiosplatformgamingindexmd"></a>[API-интерфейсы игровой iOS](~/ios/platform/gaming/index.md)
...
##  <a name="wide-coloriosplatformwide-colormd"></a>[Широкую цветовую](~/ios/platform/wide-color.md)
