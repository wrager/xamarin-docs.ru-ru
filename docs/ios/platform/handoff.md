...
[ ![](handoff-images/handoff02.png "Пример выполнения операции передачи")](handoff-images/handoff02.png)
...
[ ![](handoff-images/handoffinteractions.png "Обзор продолжение действий пользователя")](handoff-images/handoffinteractions.png)
...
4. Убедитесь, что **iCloud** службы проверки для данного ИД: 
    ...
    [ ![](handoff-images/provision01.png "Включить службу iCloud для данного ИД")](handoff-images/provision01.png)
5. Сохраните изменения.
4. Щелкните **профили подготовки** > **разработки** и создание новых разработок, подготовительный профиль для вас приложения: 

    [ ![](handoff-images/provision02.png "Создание нового профиля подготовки для приложения")](handoff-images/provision02.png)
...
6. Измените параметры проекта Xamarin.iOS и убедитесь, что вы используете подготовительный профиль, который вы только что создали: 
    ...
    [ ![](handoff-images/provision03.png "Выберите только что созданный профиль подготовки")](handoff-images/provision03.png)
7. Далее следует изменить на **Info.plist** файл и убедитесь, что вы используете идентификатор приложения, который использовался для создания профиля подготовки: 
    ...
    [ ![](handoff-images/provision04.png "Задать идентификатор приложения")](handoff-images/provision04.png)
8. Перейдите к пункту **фоновые режимы** раздел и выполните следующие действия: 

    [ ![](handoff-images/provision05.png "Включить необходимые фоновые режимы")](handoff-images/provision05.png)
...
[ ![](handoff-images/type01.png "Ключ NSUserActivityTypes и необходимые идентификаторы в редакторе plist")](handoff-images/type01.png)
...
[ ![](handoff-images/handoff01.png "Перемещение вручную примера приложения")](handoff-images/handoff01.png)
...
[ ![](handoff-images/handoff02.png "Перемещение вручную действия, отображаемого на начальном экране в левом нижнем углу")](handoff-images/handoff02.png)
...
[ ![](handoff-images/handoff03.png "Продолжение действия пользователя на новое устройство")](handoff-images/handoff03.png)
