...
Все члены, которые не связаны статически приложением осуществляется в соответствии удаляется. Таким образом этот атрибут используется для пометки членов, не были упомянуты статически, но, по-прежнему необходимы вашему приложению.

Например создания экземпляров типов динамически, можно сохранить конструктор по умолчанию для типов. При использовании XML-сериализации, можно сохранить свойства типов.

Этот атрибут можно применять для каждого члена типа, или в самом типе. Если вы хотите сохранить весь тип, можно использовать синтаксис [Сохранить (AllMembers = true)] на тип.
...
1.  [С помощью событий](#Events) .
2.  [Строго типизированные через `Delegate`свойства](#StrongDelegate) .
3.  [Слабо типизированные через `WeakDelegate`свойства](#WeakDelegate) .
...
Слабо типизированные через свойство WeakDelegate @###
...
## <a name="mapping-of-the-objective-c-delegate-pattern-to-c35"></a>Сопоставление шаблона делегата Objective-C для в &#35;
...
##### <a name="mapping-delegates-to-c35"></a>Сопоставление делегатов и &#35;
...
#### <a name="xib-outlets-and-c35"></a>& XIB выходов и C# 35;
...
>
> [![](images/designeroutlet.png "Введите имя элемента в конструкторе iOS")](images/designeroutlet.png)
>
