...
> [!IMPORTANT]
> **Примечание**: в этом документе объясняется Visual Studio для интеграции на Mac с Xcode только интерфейс построителя. Дополнительные сведения о конструкторе iOS см. в статье [iOS конструктор](~/ios/user-interface/designer/index.md) документа.
