...
> [!IMPORTANT]
> **Примечание**: safe фоновой задачи можно запускать на основной поток или в фоновом потоке, в зависимости от потребностей приложения.
...
> [!IMPORTANT]
> **Примечание**: Избегайте вызовов для обновления пользовательского интерфейса из фона в iOS 6-совместимого кода, iOS 6 не поддерживает обновления пользовательского интерфейса в фоновом режиме, а будет завершить приложение.
