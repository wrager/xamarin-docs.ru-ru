...
##### [Подключение к компьютеру Mac](get-started/installation/windows/connecting-to-mac/index.md)
###### [Устранение неполадок при подключении](get-started/installation/windows/connecting-to-mac/troubleshooting.md)
###### [Где мой компьютер Mac?](get-started/installation/windows/connecting-to-mac/visual-studio-ssh.md)
##### [Установка вручную](get-started/installation/windows/manual-installation.md)
...
### [Развертывание беспроводной сети](deploy-test/wireless-deployment.md)
...
#### [Как перейти на использование более ранней версии Xcode?](troubleshooting/questions/downgrade-xcode.md)
