---
title: watchOS трудности в Xamarin
description: В этом документе описывается работа с watchOS сложностей в Xamarin. Он содержит сведения о добавлении осложнение записи осложнение шаблонов и примеры кода.
ms.prod: xamarin
...
ms.locfileid: "34791843"
---
# <a name="watchos-complications-in-xamarin"></a>watchOS трудности в Xamarin
