...
[ ![](itunesconnect-images/agreement01.png "Управление соглашениями, налогами и банковскими операциями")](itunesconnect-images/agreement01.png)
...
1. Щелкните **My Apps** (Мои приложения):
    ...
    [ ![](itunesconnect-images/add01.png "Щелкните My Apps")](itunesconnect-images/add01.png)
2. Нажмите кнопку **+** в левом верхнем углу экрана и выберите пункт **New iOS App** (Новое приложение iOS):

    [ ![](itunesconnect-images/add02.png "Добавление нового приложения iOS")](itunesconnect-images/add02.png)
3. В iTunes Connect откроется диалоговое окно **New iOS App** (Новое приложение iOS):

    [ ![](itunesconnect-images/add03.png "Диалоговое окно New iOS App")](itunesconnect-images/add03.png)
...
[ ![](itunesconnect-images/add04.png "Новое приложение будет создано в iTunes Connect")](itunesconnect-images/add04.png)
...
5. Выберите **размер изображения** и перетащите необходимые изображения (до 5 на каждый размер экрана):
    ...
    [ ![](itunesconnect-images/screenshot01.png "Выберите размер изображения и перетащите необходимые изображения")](itunesconnect-images/screenshot01.png)
...
5. Заполните все необходимые сведения:
    ...
    [ ![](itunesconnect-images/name01.png "Изменение имени, описания, сведений о новых возможностях, ключевых слов и URL-адресов в iTunes Connect")](itunesconnect-images/name01.png)
...
5. Заполните все необходимые сведения:
    ...
    [ ![](itunesconnect-images/general01.png "Изменение общих сведений о приложении в iTunes Connect")](itunesconnect-images/general01.png)
6. Нажмите кнопку **Edit** (Изменить) рядом с элементом **Rating** (Рейтинг), чтобы указать сведения о рейтинге:

    [ ![](itunesconnect-images/general02.png "Изменение рейтинга")](itunesconnect-images/general02.png)
6. Чтобы сохранить изменения, нажмите кнопку **Save** (Сохранить) в верхней части экрана.
...
5. Заполните все необходимые сведения:
    ...
    [ ![](itunesconnect-images/gamecenter01.png "Изменение сведений Game Center в iTunes Connect")](itunesconnect-images/gamecenter01.png)
6. Чтобы сохранить изменения, нажмите кнопку **Save** (Сохранить) в верхней части экрана.

На вкладке **Game Center** можно активировать Game Center и вести **таблицы лидеров** или **достижения**:

[ ![](itunesconnect-images/gamecenter02.png "Активация Game Center")](itunesconnect-images/gamecenter02.png)

[ ![](itunesconnect-images/gamecenter03.png "Ведение таблиц лидеров и достижений для приложения")](itunesconnect-images/gamecenter03.png)
...
5. Заполните все необходимые сведения:
    ...
    [ ![](itunesconnect-images/review01.png "Изменение сведений о проверке приложения в iTunes Connect")](itunesconnect-images/review01.png)
6. Выберите требуемый способ выпуска приложения в App Store после его успешной проверки:

    [ ![](itunesconnect-images/review02.png "Изменение сведений о выпуске в iTunes Connect")](itunesconnect-images/review02.png)
6. Чтобы сохранить изменения, нажмите кнопку **Save** (Сохранить) в верхней части экрана.
...
[ ![](itunesconnect-images/price01.png "Сведения о расценках")](itunesconnect-images/price01.png)
...
3. Перейдите на вкладку **Pricing** (Цены):
    ...
    [ ![](itunesconnect-images/price02.png "Изменение сведений о расценках в iTunes Connect")](itunesconnect-images/price02.png)
...
[ ![](itunesconnect-images/inapp01.png "Сведения о покупках из приложения")](itunesconnect-images/inapp01.png)
...
[ ![](itunesconnect-images/reviews01.png "Просмотр отзывов о приложении")](itunesconnect-images/reviews01.png)
