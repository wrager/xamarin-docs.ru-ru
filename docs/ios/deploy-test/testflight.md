...
[![ ] (testflight-images/validate-build.png "Отправка приложения в Apple")](testflight-images/validate-build.png)
...
2.  Выберите **Мои приложения**:
    ...
    [ ![](testflight-images/my-apps.png "Выберите "Мои приложения"")](testflight-images/my-apps.png)
...
[![ ] (testflight-images/infoplist.png "Файл Info.plist приложения")](testflight-images/infoplist.png)
[ ![](testflight-images/newiosapp.png "Форма в iTunes Connect")](testflight-images/newiosapp.png)
...
###  <a name="create-an-archive"></a>Создание архива
 ...
 [ ![](testflight-images/new-archive.png "Выберите "Архивирование для публикации"")](testflight-images/new-archive.png)
...
[ ![](testflight-images/archive-view.png "После создания архива будет автоматически открыто окно "Архивы"")](testflight-images/archive-view.png)
...
[ ![](testflight-images/group.png "Выберите удостоверение подписывания и профиль подготовки или подпишите повторно другим удостоверением")](testflight-images/group.png)
...
[![ ] (testflight-images/app-uploaded.png "Вкладки со сборками, внутренними тестировщиками и внешними тестировщиками")](testflight-images/app-uploaded.png)

Чтобы добавить метаданные к приложению, нажмите номер сборки и затем TestFlight:

[ ![](testflight-images/metadata.png "Добавление метаданных")](testflight-images/metadata.png)
...
[![ ] (testflight-images/turn-on-testing.png "Включите переключатель "Бета-тестирование TestFlight"")](testflight-images/turn-on-testing.png)
...
[ ![](testflight-images/daysleft.png "Страница "Сведения о тестировании"")](testflight-images/daysleft.png)
...
[ ![](testflight-images/users-and-roles.png ""Пользователи и роли" на начальном экране iTunes Connect")](testflight-images/users-and-roles.png)
...
[ ![](testflight-images/internal-tester.png "Включите переключатель "Внутренний тестировщик"")](testflight-images/internal-tester.png)
...
[ ![](testflight-images/add-new-user.png "Добавление пользователя")](testflight-images/add-new-user.png)
...
[![ ] (testflight-images/select-users.png "Список пользователей, добавленных для внутреннего бета-тестирования в TestFlight")](testflight-images/select-users.png)
...
[ ![](testflight-images/status-added.png "Состояние приглашения")](testflight-images/status-added.png)
...
[ ![](testflight-images/beta-app-review.png "Отправка на проверку бета-версии")](testflight-images/beta-app-review.png)
...
[ ![](testflight-images/add-external.png "Приглашение тестировщиков")](testflight-images/add-external.png)
...
[ ![](testflight-images/confirm-consent.png "Подтвердите, что у вас есть согласие пользователей на их приглашение")](testflight-images/confirm-consent.png)
...
[ ![](testflight-images/tester-email.png "Пример приглашения")](testflight-images/tester-email.png)
...
[ ![](testflight-images/install-app.png "TestFlight отображает подробные сведения о том, что именно необходимо протестировать")](testflight-images/install-app.png)
...
[ ![](testflight-images/submit-for-review.png "Нажмите кнопку "Отправить на проверку"")](testflight-images/submit-for-review.png)
