...
> [!IMPORTANT]
> Примечание. Файл Entitlements.plist помогает заполнить правильные свойства приложения при помощи возможностей, но он не может создать профиль подготовки, поскольку не связан с учетной записью разработчика Apple. Для создания профиля подготовки, для развертывания и распространения приложения вам все еще нужно будет воспользоваться порталом разработчика.
