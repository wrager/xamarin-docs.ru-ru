...
description: В этом документе описываются различные способы размещения пользовательских интерфейсов в Xamarin.iOS. В нем описывается автоматическое изменение размера и автоматический макет.
ms.prod: xamarin
