...
description: Этот документ описывает MonoTouch.Dialog основанное на атрибутах отражение API, который создает пользовательский Интерфейс на основе классов атрибуты.
ms.prod: xamarin
