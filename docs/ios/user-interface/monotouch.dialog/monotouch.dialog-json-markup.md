...
description: В этом документе описывается синтаксис JSON, который может использоваться для построения Xamarin.iOS пользовательский интерфейс, с помощью MonoTouch.Dialog.
ms.prod: xamarin
