...
description: В этом руководстве представлены iOS автоматический макет и описывает, как использовать конструктор Xamarin для операций ввода-вывода для создания и редактирования макеты с помощью ограничений. В нем также описывается изменение ограничения в коде, анимация изменения ограничения и многое другое.
ms.prod: xamarin
