---
title: Общие сведения о раскадровки в Xamarin.iOS
description: Этот документ содержит вводные сведения о раскадровки в Xamarin.iOS. Он описывает использование раскадровки для определения пользовательского интерфейса, segues и как использовать для редактирования файлов раскадровки iOS конструктора.
ms.prod: xamarin
...
ms.locfileid: "34790972"
---
# <a name="introduction-to-storyboards-in-xamarinios"></a>Общие сведения о раскадровки в Xamarin.iOS
...
> [!IMPORTANT]
> Если вы используете VMWare для вашей виртуальной машине Windows, удерживая клавишу CTRL сопоставлен как _щелкните правой кнопкой мыши_ кнопку мыши по умолчанию. Чтобы создать Segue, изменение параметров клавиатуры через **предпочтения** > **клавиатуру и мышь** > **сочетания клавиш мыши** и повторно сопоставить вашей **Вторую кнопку** как показано ниже:
> 
...
|Перейти|Описание:|
|--- |--- |
|Показать|Это очень похоже на перейти Push, но он учитывает содержимого экрана.|
|Показать подробности|Если приложение отображает master и подробное представление (например, в контроллер представление разбиение на iPad), содержимое будет заменен подробное представление. Если приложение отображает только master или подробности, содержимое заменяет верхнюю часть стека контроллера представления.|
|Presentation|Это аналогично модального segue и позволяет разрешенных стилей представления и перехода.|
|Popover презентации|Это представляет содержимое в виде popover|
