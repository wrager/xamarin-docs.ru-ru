---
title: Ограничения программный макета в Xamarin.iOS
...
ms.locfileid: "34790605"
---
# <a name="programmatic-layout-constraints-in-xamarinios"></a>Ограничения программный макета в Xamarin.iOS
...
> [!IMPORTANT]
> Помимо стандартного набора свойств привязки, также включают представления iOS `LayoutMarginsGuides` и `ReadableContentGuide` свойства. Эти свойства предоставляют `UILayoutGuide` объекты для работы с полями представления и для чтения содержимого руководства соответственно.
